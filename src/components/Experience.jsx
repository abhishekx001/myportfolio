        ...
        <section id="experience" className="py-20 px-4">
            <div className="max-w-6xl mx-auto">
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    className="text-3xl font-bold text-center mb-16 text-gradient"
                >
                    Work Experience
                </motion.h2>

                <div className="space-y-12 relative border-l-2 border-slate-700 ml-4 md:ml-10 pl-8 md:pl-12">
                    {experiences.map((exp, index) => (
                        ...
                        >
                            <span className="absolute -left-[45px] top-0 bg-primary-600 w-6 h-6 rounded-full border-4 border-dark-900 group-hover:scale-125 transition-transform duration-300" />

                            <div className="glass-card p-6 md:p-8 rounded-2xl hover:bg-slate-800/50 transition-colors duration-300">
                                <div className="flex flex-col md:flex-row justify-between mb-4">
                                    <div>
                                        <h3 className="text-xl font-bold text-white mb-1 group-hover:text-primary-500 transition-colors">
                                            {exp.role}
                                        </h3>
